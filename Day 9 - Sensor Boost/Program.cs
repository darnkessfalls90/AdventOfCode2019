...
namespace SensorBoost
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var program1 = program.DeepCopy();
            interpreter.Interpret(ref program1);

            Console.WriteLine("Part 2:");
            input = 2;
            IntcodeInterpreter interpreter2 = new IntcodeInterpreter();
            interpreter2.HandleOutput += Interpreter_HandleOutput;
            interpreter2.TakeInput += Interpreter_TakeInput;

            var program2 = program.DeepCopy();
            interpreter2.Interpret(ref program2);
            Console.ReadLine();
